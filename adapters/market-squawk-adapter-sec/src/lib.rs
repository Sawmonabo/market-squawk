...
pub use bulk::{
    ...
    SecFundHoldingCandidate, SecFundHoldingCandidatesQuery, SecFundHoldingIdentityInput,
    SecFundIdentityAuthority, SecFundIdentityResolution, SecFundPartitionAdmissions,
