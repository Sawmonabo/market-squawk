...
RENAME TO provider_onboarding_events_before_activation_quarantine;
...
SELECT
    ...
    occurred_at_ns,
    audit_sequence
FROM provider_onboarding_events_before_activation_quarantine;

DROP TABLE provider_onboarding_events_before_activation_quarantine;
