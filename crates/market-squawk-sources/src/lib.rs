...
pub use extraction::{
    ...
    ObservedVersionEvidence, ObservedVersionKind, PROVIDER_NATIVE_LINEAGE_SCHEMA_VERSION,
    PitV1CanonicalEncoder, PitV1EncodingControl, PitV1EncodingError, ProviderCaptureBindingLayout,
    ProviderCaptureComponentToken, ProviderCaptureComponentTokenSet, ProviderCaptureError,
    ProviderCaptureMaterial, ProviderCaptureMaterialSealError, ProviderCapturePageReceipt,
    ProviderCaptureRequestGraphComponent, ProviderCaptureRowFrame, ProviderCaptureScope,
    ...
    ProviderEventMicrobatchToken, ProviderNativeLineageBatch, ProviderNativeLineageBatchBuilder,
    ProviderNativeLineageError, ProviderNativeLineageImplementation, ProviderNativeLineageRow,
    ProviderNativeLineageSchema, ProviderOrderedCaptureSegments, ProviderWholeCaptureToken,
    RejoinedProviderCapture, SealedProviderCaptureBinding, SealedProviderCaptureMaterial,
    SealedProviderCaptureSetReceipt, SealedProviderEventMicrobatchReceipt, SourceObject,
