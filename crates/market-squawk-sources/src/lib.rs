...
pub use extraction::{
    ...
    ProviderOrderedCaptureSegments, ProviderWholeCaptureToken, RejoinedProviderCapture,
    SealedProviderCaptureBinding, SealedProviderCaptureMaterial, SealedProviderCaptureSetReceipt,
    SealedProviderEventMicrobatchReceipt, SourceObject, SourceObjectCaptureIdentity,
    payload_matches_exact_evidence, verify_provider_native_lineage_batch_evidence,
};
pub use health::{
