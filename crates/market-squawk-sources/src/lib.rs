...
pub use extraction::{
    ...
    ExtractionBatchAccumulator, ExtractionContentIdentity, ExtractionError, ExtractionRecord,
    ExtractionRequest, ExtractionRequestId, ExtractionSource, ExtractionSourceError,
