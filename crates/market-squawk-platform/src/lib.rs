...
pub use capture::{
    CaptureAdmissionReceipt, CaptureGenerationError, CaptureGenerationKey, CaptureHealthEvent,
    ...
    MemoryCaptureSink, RawCaptureControl, RawCapturePublisher, RawCaptureWriter,
