...
pub use paths::{
    ArtifactPathError, ArtifactRoot, CatalogFileGuard, CatalogLocation, CatalogRestoreStage,
    CatalogRestoreTarget, CatalogWriterGuard, InstalledCatalogFile, JournalFileFormat,
