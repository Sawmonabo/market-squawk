...
pub use investment_proposal::{
    ...
    CostAdjustedPitBacktestEvidence, FinancialModelEvidence, FinancialModelValueRange,
    ForecastCalibrationSummary, ForecastPriceRanges, GeneratedInvestmentProposal,
    GeneratedPriceLadder, HarmonicPatternEvidenceReceipt, InvestmentAnalysisEvidence,
    ...
    MAX_PROPOSAL_INVALIDATORS, MarketReferenceAdjustmentBasis, MarketReferenceEvidence,
    ...
    ProposalTimeBenchmarkAvailability, ProposalUnavailableReason, RECOMMENDATION_ASSUMPTION_COUNT,
