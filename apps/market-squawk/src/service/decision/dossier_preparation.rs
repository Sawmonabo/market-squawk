...
fn inventory_value(value: &DossierEvidenceInventory, catalog: &DossierEvidenceCatalog) -> Value {
    json!({
        ...
        "selectedAt": super::product_timestamp(value.selected_at),
...
fn preview_value(value: &PreparedDossierPreview) -> Value {
    json!({
        ...
        "assembledAt": super::product_timestamp(value.assembled_at),
        "receiptExpiresAt": super::product_timestamp(value.receipt_expires_at),
    })
}
...
impl ForecastEvidenceOption {
    fn value(&self) -> Value {
        json!({
            ...
            "observedThrough": super::product_timestamp(self.observed_through),
            "createdAt": super::product_timestamp(self.created_at),
            "expiresAt": super::product_timestamp(self.expires_at),
...
impl FairValueEvidenceOption {
    ...
    fn value(&self) -> Value {
        json!({
            ...
            "measurementAt": super::product_timestamp(self.measurement_at),
            "preparedAt": super::product_timestamp(self.prepared_at),
            "method": self.method,
