...
fn inventory_value(inventory: &TargetEvidenceInventory) -> Value {
    json!({
        ...
        "assembledAt": super::product_timestamp(inventory.assembled_at),
        ...
        "referenceMarks": inventory.reference_marks.iter().map(|option| json!({
            ...
            "observedAt": super::product_timestamp(option.observed_at),
...
fn preview_value(preview: &PreparedTargetPreview) -> Value {
    json!({
        ...
        "receiptExpiresAt": super::product_timestamp(preview.receipt_expires_at),
        ...
        "referenceMarkObservedAt": super::product_timestamp(preview.reference_mark_observed_at),
        ...
        "createdAt": super::product_timestamp(preview.created_at),
        "horizonAt": super::product_timestamp(preview.horizon_at),
        "expiresAt": super::product_timestamp(preview.expires_at),
        "reviewDueAt": super::product_timestamp(preview.review_due_at),
