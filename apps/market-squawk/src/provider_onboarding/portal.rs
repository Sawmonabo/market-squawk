...
const INDEX_HTML: &str = include_str!("../../assets/provider-onboarding/index.html");
const PORTAL_CSS: &str = include_str!("../../assets/provider-onboarding/portal.css");
const PORTAL_JAVASCRIPT: &str = include_str!("../../assets/provider-onboarding/portal.js");
