...
const availabilityEvidenceSchema = z.discriminatedUnion("kind", [
  z
    .object({
      ...
      available_at: losslessIntegerSchema,
      evidence: z.string().min(1),
    })
    .strict(),
  z
    .object({
      kind: z.literal("local_first_observed"),
      observed_at: losslessIntegerSchema,
    })
    .strict(),
  z
    .object({
      kind: z.literal("inferred"),
      inferred_at: losslessIntegerSchema,
