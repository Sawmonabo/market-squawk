...
ALLOWED_OCCURRENCES = {
    ...
    ("docs/architecture/target-state.md", 593, 2): AllowedOccurrence(
        f"- Readers accept committed `{TOKENS[3]}/{TOKENS[2]}` and renamed `MSJ1/.msj` journals."
    ),
    ("docs/architecture/target-state.md", 593, 3): AllowedOccurrence(
        f"- Readers accept committed `{TOKENS[3]}/{TOKENS[2]}` and renamed `MSJ1/.msj` journals."
    ),
    ...
    ("docs/superpowers/plans/2026-07-16-market-squawk-stage-1-foundation.md", 1730, 2): AllowedOccurrence(
        f"- [ ] Legacy `{TOKENS[3]}/{TOKENS[2]}` journals read; current writes use `MSJ1/.msj`."
    ),
    ("docs/superpowers/plans/2026-07-16-market-squawk-stage-1-foundation.md", 1730, 3): AllowedOccurrence(
        f"- [ ] Legacy `{TOKENS[3]}/{TOKENS[2]}` journals read; current writes use `MSJ1/.msj`."
    ),
}
